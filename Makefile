#############################################################################
# Makefile for building: asm
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? 22. ??? 20:37:57 2014
# Project:  asm.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe -spec c:\Qt\4.8.5\mkspecs\win32-msvc2010 CONFIG+=declarative_debug -o Makefile asm.pro
#############################################################################
...
Makefile: asm.pro  c:\Qt\4.8.5\mkspecs\win32-msvc2010\qmake.conf c:\Qt\4.8.5\mkspecs\qconfig.pri \
		...
		c:\Qt\4.8.5\mkspecs\features\warn_off.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.5\mkspecs\win32-msvc2010 CONFIG+=declarative_debug -o Makefile asm.pro
...
clean: debug-clean release-clean FORCE
	-$(DEL_FILE) "tmp\obj\debug\asm.intermediate.manifest"
	-$(DEL_FILE) debug\app\asm.exp
	-$(DEL_FILE) debug\app\asm.ilk
	-$(DEL_FILE) vc*.pdb
	-$(DEL_FILE) vc*.idb
distclean: debug-distclean release-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) debug\app\asm.pdb
